        ...
        {calendarDays.map((day, index) => {
          ...
          return (
            ...
            >
              {/* Day Number */}
              <div
                className={`text-xs sm:text-sm lg:text-base font-medium text-center mb-1
              ...
              {dayTasks.length > 0 && isCurrentMonth && (
                <div className="flex-1 flex flex-col items-center justify-center">
                  ...
                  <div
                    className={`text-[6px] sm:text-[8px] lg:text-[10px] text-center leading-tight mb-1 line-clamp-2
                    ${
